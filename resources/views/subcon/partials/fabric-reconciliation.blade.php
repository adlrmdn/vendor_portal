{{--
    Material Reconciliation — two sub-sections: Fabric (leftover fabric
    ...
    have no such breakdown — just a directly-entered quantity (rendered by
    the shared subcon.partials.material-recon-accessory sub-partial, also
    used standalone by consumption-input.blade.php on the Final Approval /
    Report Validation form, which shows Fabric itself via a different table
    — so only the Accessory sub-section is reused there).
    Params:
