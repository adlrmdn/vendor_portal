        ...
        <div class="col-12 col-md-7 col-lg-6">
            <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                <div class="card-body text-center p-5">
                    ...
                    <p class="text-muted mb-4">You are about to <strong>reject</strong> the Head Office approval for this packaging inspection. This is recorded immediately and cannot be undone.</p>
                    ...
                    <form method="POST" action="{{ route('qc.ho-decline.submit', ['token' => $token]) }}">
                        @csrf
