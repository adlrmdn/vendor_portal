...
<form method="GET" action="{{ route('finance.admin.invoices') }}" class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-sm-3 d-flex gap-2">
                ...
                @if($hasFilters)
                    <a href="{{ route('finance.admin.invoices') }}" class="btn btn-sm btn-outline-secondary" title="Clear filters"><i class="fas fa-times"></i></a>
                @endif
            </div>
        </div>
    </div>
                ...
                fetch(`${toggleUrlBase}/${id}/toggle`, {
                    ...
                    .then(data => {
                        if (data.forced_complete) {
                            // Status/reason/report columns for this row are now stale —
                            // simplest correct fix is a fresh render.
